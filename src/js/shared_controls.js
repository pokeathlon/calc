...
$(".ability").bind("keyup change", function () {
	...
	var TOGGLE_ABILITIES = ['Flash Fire', 'Intimidate', 'Minus', 'Plus', 'Slow Start', 'Unburden', 'Stakeout', 'Teraform Zero', 'Petrify', 'Adaptive Armor', 'As Above'];
...
function createField() {
	...
	return new calc.Field({
		...
		isMagicRoom: isMagicRoom, isWonderRoom: isWonderRoom, isGravity: isGravity, isTrickRoom: isTrickRoom,
